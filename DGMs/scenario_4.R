...
for (size in sizes) {
  ...
  saveRDS(dataset, file = paste0("live/data/scenario_4_", size, ".RDS"))
}
...
saveRDS(oracle_list, file = paste0("live/data/scenario_4_oracle.RDS"))
...
# saveRDS(gates, paste0("live/data/scenario_4_true_GATEs", size, ".rds"))
