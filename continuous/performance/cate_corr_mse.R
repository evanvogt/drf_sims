...
cate_preds <- readRDS("live/results/continuous/all/cate_preds.RDS")
...
saveRDS(cate_corr, "live/results/continuous/all/cate_correlations.RDS")
saveRDS(cate_mse, "live/results/continuous/all/cate_mses.RDS")
saveRDS(cate_bias, "live/results/continuous/all/cate_bias.RDS")
saveRDS(cate_coverage, "live/results/continuous/all/cate_coverage.RDS")
saveRDS(ci_length, "live/results/continuous/all/ci_length.RDS")
