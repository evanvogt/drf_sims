...
# alpha/2) x MCSE) error bar, faceted by scenario.
#
...
# at the proper 95% CI below; see continuous/cts_results.R). qnorm(1 -
# alpha/2), not a hardcoded 1.96, to match R/metrics.R::normal_interval's
# convention.
...
instead of an estimator's fitted ones (`cts_true_cate_tests.RDS` —
