...
#PBS -J 1-2
#PBS -N cts_1000
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/continuous/all_methods/jobscripts/logs_1000
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/continuous/all_methods/jobscripts/logs_1000
...
jobid=$(sed -n "${PBS_ARRAY_INDEX}p" failed_ids_1000.txt)
