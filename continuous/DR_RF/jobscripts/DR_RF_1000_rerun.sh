...
#PBS -l select=1:ncpus=23:ompthreads=23:mem=11gb
#PBS -J 1-2
#PBS -N DR_RF_1000_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/continuous/DR_RF/jobscripts/logs_1000/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/continuous/DR_RF/jobscripts/logs_1000/
...
cd "/rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/continuous/DR_RF/jobscripts"
