...
bias_sum_plot <- metrics_summary %>%
  ...
  labs(title = "Average Bias distribution in CATE estimates",
       y = "Average bias",
       x = "Sample size")
ggsave("bin_bias_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
mse_sum_plot <- metrics_summary %>%
  ...
  labs(title = "Average MSE distribution in CATE estimates",
       y = "Average MSE",
       x = "Sample size")
ggsave("bin_mse_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
ggsave("bin_bias_mse.png", path = fig_path, width = 21, height = 15, units = "cm")
...
corr_sum_plot <- metrics_summary %>%
  ...
  labs(title = "Mean correlations of true vs estiated CATEs",
       y = "Correlation",
       x = "sample_size")
ggsave("bin_corr_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
BLP_sum_plot <- metrics_summary %>%
  ...
  labs(title = "BLP test p-values",
       y = "p-value",
       x = "sample_size")
ggsave("bin_blp_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
indep_cate_sum_plot <- metrics_summary %>%
  ...
  labs(title = "CATE-independence test p-values",
       y = "p-value",
       x = "sample_size")
ggsave("bin_indep_cate_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
indep_po_sum_plot <- metrics_summary %>%
  ...
  labs(title = "PO-independence test p-values",
       y = "p-value",
       x = "sample_size")
ggsave("bin_indep_po_summary.png", path = fig_path, width = 21, height = 15, units = "cm")
...
all_tests_plot <- metrics %>%
  ...
  labs(y = "Model",
       x = "Independence test p-value") +
  xlim(0,1)
ggsave("bin_tests_all.png", path = fig_path, width = 21, height = 15, units = "cm")
