...
#PBS -J 1-10000
#PBS -N miss_cts_mi_1000
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/missing/continuous/jobscripts/logs_1000_mi
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/missing/continuous/jobscripts/logs_1000_mi
...
for miss_type in "${miss_types[@]}"; do
    ...
    Rscript cts_miss_analysis.R "$scenario" "$n" "$sim_id" "$miss_type" "$miss_prop" "multiple_imputation"
done