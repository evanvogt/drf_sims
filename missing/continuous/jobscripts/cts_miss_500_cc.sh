...
#PBS -J 1-10000
#PBS -N miss_cts_cc_500
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/missing/continuous/jobscripts/logs_500_cc
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/missing/continuous/jobscripts/logs_500_cc
