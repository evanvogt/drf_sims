##########
# title: metrics for cts outcome confidence intervals
##########
...
out_file <- file.path(res_path, "ci_cts_metrics.RDS")
...
# results list
all_results_df <- readRDS(file.path(res_path, "ci_cts_all.RDS"))
