###############
# title: Data Generating Mechansims for CIs - bin outcome
###############

# Define scenario parameters for binary outcomes
...
#' Generate binary outcome dataset for specified scenario
#' 
...
#' @param bW Treatment effect coefficient (from generate_binary_scenario_data)
