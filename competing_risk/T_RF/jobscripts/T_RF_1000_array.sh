...
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/T_RF/jobscripts/logs_1000/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/T_RF/jobscripts/logs_1000/
