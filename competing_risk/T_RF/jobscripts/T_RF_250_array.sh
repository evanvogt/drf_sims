...
#PBS -J 1-10000
#PBS -N T_RF_250_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/T_RF/jobscripts/logs_250/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/T_RF/jobscripts/logs_250/
...
cd "/rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/T_RF"
