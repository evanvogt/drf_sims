...
source("/rds/general/project/nihr_drf_simulations/live/scripts/drf_sims/competing_risk/cause_spec/model_functions_cause_spec.R")
...
# Save results
output_dir <- paste0("live/results/competing_risk/cause_spec/scenario_", scenario, "/", n, "/all_methods/")
