...
#PBS -J 1-7000
#PBS -N surv_1000
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/competing_risk/jobscripts/logs_1000
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/competing_risk/jobscripts/logs_1000
