...
#PBS -l select=1:ncpus=5:ompthreads=5:mem=1gb
#PBS -J 1-10000
#PBS -N CF_250_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/CF/jobscripts/logs_250/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/CF/jobscripts/logs_250/
...
cd "/rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/CF"
