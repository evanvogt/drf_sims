...
#PBS -J 1-10000 
#PBS -N CF_5000_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/CF/jobscripts/logs_5000/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/CF/jobscripts/logs_5000/
