...
for (size in sizes) {
  ...
  saveRDS(dataset, file = paste0("live/data/competing_risk//scenario_7_", size, ".RDS"))
}
...
saveRDS(oracle_list, file = paste0("live/data/competing_risk//scenario_7_oracle.RDS"))
