...
for (size in sizes) {
  ...
  saveRDS(dataset, file = paste0("live/data/competing_risk//scenario_5_", size, ".RDS"))
}
...
saveRDS(oracle_list, file = paste0("live/data/competing_risk//scenario_5_oracle.RDS"))
