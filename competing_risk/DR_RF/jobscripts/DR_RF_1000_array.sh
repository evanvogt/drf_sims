...
#PBS -l select=1:ncpus=15:ompthreads=15:mem=7gb
#PBS -J 1-10000
#PBS -N DR_RF_1000_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/DR_RF/jobscripts/logs_1000/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/DR_RF/jobscripts/logs_1000/
...
cd "/rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/competing_risk/DR_RF"
