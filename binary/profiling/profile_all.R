# run all the models for one simulations across all scenarios ?
# this might be quicker computationally?

# make this script to run across all the scenarios and sample sizes once
...
saveRDS(profiling, "live/data/binary/profiling/run_all_once.RDS")
