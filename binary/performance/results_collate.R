...
# functions
source("live/scripts/binary/functions/extract_results.R")
...
saveRDS(cate_preds, paste0("live/results/binary/all/cate_preds.RDS"))
print("cate done!")

BLP_folds <- extract_results("BLP_tests_all", scens, samplesizes, models)
saveRDS(BLP_folds, paste0("live/results/binary/all/BLP_folds.RDS"))
print("BLP folds done!")

BLP_wholes <- extract_results("BLP_whole_all", scens, samplesizes, models)
saveRDS(BLP_wholes, paste0("live/results/binary/all/BLP_wholes.RDS"))
print("BLP whole done!")

TEVIM_preds <- extract_results("te_vims_all", scens, samplesizes, models)
saveRDS(TEVIM_preds, paste0("live/results/binary/all/te_vims.RDS"))
print("TEVIMS done!")
