...
#PBS -J 1-10000
#PBS -N DR_semi_oracle_250_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_semi_oracle/jobscripts/logs_250/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_semi_oracle/jobscripts/logs_250/
