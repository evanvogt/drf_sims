...
#PBS -l select=1:ncpus=20:ompthreads=20:mem=20gb
#PBS -J 1-10000
#PBS -N DR_SL_500_array
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_superlearner/jobscripts/logs_500/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_superlearner/jobscripts/logs_500/
