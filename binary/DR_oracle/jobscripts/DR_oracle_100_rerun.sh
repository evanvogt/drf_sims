...
#PBS -l select=1:ncpus=15:mem=8gb
#PBS -J 1-380
#PBS -N DR_oracle_100_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_oracle/jobscripts/logs_100/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_oracle/jobscripts/logs_100/
...
cd "/rds/general/project/nihr_drf_simulations/live/scripts/binary/DR_oracle/jobscripts"
