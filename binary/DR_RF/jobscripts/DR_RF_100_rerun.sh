...
#PBS -J 1-23
#PBS -N DR_RF_100_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_RF/jobscripts/logs_100/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/DR_RF/jobscripts/logs_100/
...
cd "/rds/general/project/nihr_drf_simulations/live/scripts/binary/DR_RF/jobscripts"
