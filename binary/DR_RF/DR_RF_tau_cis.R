...
# Save results
saveRDS(CATEs, paste0(c("live/results/binary/", scenario, "/", n, "/DR_RF/", "taus_cis.RDS"), collapse = ""))
saveRDS(BLP_tests, paste0(c("live/results/binary/", scenario, "/", n, "/DR_RF/", "BLP.RDS"), collapse = ""))
saveRDS(draws, paste0(c("live/results/binary/", scenario, "/", n, "/DR_RF/", "draws.RDS"), collapse = ""))