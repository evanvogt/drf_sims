...
#PBS -J 1-5
#PBS -N bin_100_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/binary/all_methods/jobscripts/logs_100
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/binary/all_methods/jobscripts/logs_100
