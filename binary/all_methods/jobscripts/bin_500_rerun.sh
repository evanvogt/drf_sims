...
#PBS -J 1-24
#PBS -N bin_500_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/binary/all_methods/jobscripts/logs_500
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/binary/all_methods/jobscripts/logs_500
...
cd "/rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/drf_sims/binary/all_methods/jobscripts"
jobid=$(sed -n "${PBS_ARRAY_INDEX}p" failed_ids_500.txt)
