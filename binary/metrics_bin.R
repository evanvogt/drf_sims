###############
# title: Compute performance metrics - binary outcome
# updated 20/08/2025
###############
...
results <- readRDS(paste0(res_path, "new_format/binary_all.RDS"))
...
saveRDS(metrics, paste0(res_path, "new_format/metrics_binary_nested.RDS"))
saveRDS(metrics_df, paste0(res_path, "new_format/metrics_binary_tidy.RDS"))
