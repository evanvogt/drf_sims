...
#PBS -J 1-100
#PBS -N CF_100_rerun
#PBS -o /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/CF/jobscripts/logs_100/
#PBS -e /rds/general/user/evanvogt/projects/nihr_drf_simulations/live/scripts/binary/CF/jobscripts/logs_100/
...
cd "/rds/general/project/nihr_drf_simulations/live/scripts/binary/CF/jobscripts"
...
echo "rerunning failed simulation: scenario_$scenario_$n, simulation: $sim_id"
