...
Last updated: 2026-08-19 09:05 BST
...
| competing_risk | crossfit_rerun |  1400 |  1364 |   36 |  97.4 | in_progress | NA | NA | not_applicable | crossfitting strategy change - the last production study still double-crossfitting; now runs clean end-to-end, so this is its first run under the new strategy |
| confidence_intervals/optimal_sf (bin) | crossfit_rerun |  2000 |   953 | 1047 |  47.6 | in_progress | NA | NA | not_applicable | crossfitting strategy change; also the DGM was wrong (see confidence_intervals/optimal_sf README) |
| confidence_intervals/optimal_sf (cts) | crossfit_rerun |  2000 |   915 | 1085 |  45.8 | in_progress | NA | NA | not_applicable | crossfitting strategy change |
| missing/ci_example | crossfit_rerun |   500 |   356 |  144 |  71.2 | in_progress | NA | NA | not_applicable | crossfitting strategy change |
